...
setup(
    ...
    entry_points={"console_scripts": ["sway-smart-workspace=sway_smart_workspace.smart_workspace:main"]},
    scripts=["sway_smart_workspace/smart_workspace.py"],
    long_description=long_description,
    long_description_content_type='text/markdown',
    author='Asger Geel Weirsøe',
    author_email='asger@weirsoe.dk',
    description='Simple program that looks through the sway config and finds the bound workspaces for each output.py, and then opening that workspace on the output.py, that the mouse is currently on.',
    classifiers=[
